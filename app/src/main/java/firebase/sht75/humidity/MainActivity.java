...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(firebase.sht75.humidity.R.layout.activity_main);

        textView_humidity1 = (TextView) this.findViewById(firebase.sht75.humidity.R.id.humidity1);
        textView_temperature1 = (TextView) this.findViewById(firebase.sht75.humidity.R.id.temperature1);
        textView_humidity2 = (TextView) this.findViewById(firebase.sht75.humidity.R.id.humidity2);
        textView_temperature2 = (TextView) this.findViewById(firebase.sht75.humidity.R.id.temperature2);
        textView_humidity3 = (TextView) this.findViewById(firebase.sht75.humidity.R.id.humidity3);
        textView_temperature3 = (TextView) this.findViewById(firebase.sht75.humidity.R.id.temperature3);
        textView_humidity4 = (TextView) this.findViewById(firebase.sht75.humidity.R.id.humidity4);
        textView_temperature4 = (TextView) this.findViewById(firebase.sht75.humidity.R.id.temperature4);
        textView_humidity5 = (TextView) this.findViewById(firebase.sht75.humidity.R.id.humidity5);
        textView_temperature5 = (TextView) this.findViewById(firebase.sht75.humidity.R.id.temperature5);

        out_of_range1 = (TextView) this.findViewById(firebase.sht75.humidity.R.id.out_of_range1);
        out_of_range2 = (TextView) this.findViewById(firebase.sht75.humidity.R.id.out_of_range2);
        out_of_range3 = (TextView) this.findViewById(firebase.sht75.humidity.R.id.out_of_range3);
        out_of_range4 = (TextView) this.findViewById(firebase.sht75.humidity.R.id.out_of_range4);
        out_of_range5 = (TextView) this.findViewById(firebase.sht75.humidity.R.id.out_of_range5);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == SIGN_IN_REQUEST_CODE) {
            if(resultCode == RESULT_OK) {
                makeToast(getResources().getString(firebase.sht75.humidity.R.string.signed_in), this);
                currentUserAuth = FirebaseAuth.getInstance().getCurrentUser();
                ...
                makeToast(getResources().getString(firebase.sht75.humidity.R.string.could_not_sign_you_in), this);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(firebase.sht75.humidity.R.menu.main_activity_menu, menu);
        return super.onCreateOptionsMenu(menu);
    }

    @Override
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == firebase.sht75.humidity.R.id.main_menu_plot){
            Intent myIntent = new Intent(MainActivity.this, Sensor2Activity.class);
            MainActivity.this.startActivity(myIntent);
        }
        if (item.getItemId() == firebase.sht75.humidity.R.id.main_menu_notification){
