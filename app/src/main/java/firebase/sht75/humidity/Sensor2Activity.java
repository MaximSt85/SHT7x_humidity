...
public class Sensor2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(firebase.sht75.humidity.R.layout.activity_sensor2);

        setTitle(getResources().getString(firebase.sht75.humidity.R.string.plot));

        firebaseNotifier = new FirebaseObservable();

        dynamicPlot = (XYPlot) findViewById(firebase.sht75.humidity.R.id.dynamicXYPlot);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(firebase.sht75.humidity.R.menu.plot_menu, menu);
        return true;
    }

    @Override
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == firebase.sht75.humidity.R.id.plot_menu_sensor1){
            if (state[0]) {
                state[0] = false;
                state[1] = true;
                state[2] = true;
        ...
        if (item.getItemId() == firebase.sht75.humidity.R.id.plot_menu_sensor2){
            if (state[1]) {
                state[1] = false;
                state[0] = true;
                state[2] = true;
        ...
        if (item.getItemId() == firebase.sht75.humidity.R.id.plot_menu_sensor3) {
            if (state[2]) {
                state[2] = false;
                state[0] = true;
                state[1] = true;
        ...
        if (item.getItemId() == firebase.sht75.humidity.R.id.plot_menu_sensor4){
            if (state[3]) {
                state[3] = false;
                state[0] = true;
                state[1] = true;
        ...
        if (item.getItemId() == firebase.sht75.humidity.R.id.plot_menu_sensor5){
            if (state[4]) {
                state[4] = false;
                state[0] = true;
                state[1] = true;
